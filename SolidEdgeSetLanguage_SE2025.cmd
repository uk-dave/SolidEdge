...
set SE_HOME=C:\Program Files\Siemens\Solid Edge 2025
...
rem
:ChangeLang
reg delete "HKCU\Software\Siemens\Solid Edge\Version 225" /v DefaultToSystemLocale /f >nul 2>&1

reg delete "HKCU\Software\Siemens\Solid Edge\Version 225" /v RuntimeLanguage /f >nul 2>&1

reg add "HKLM\Software\Siemens\Solid Edge\Version 225\CurrentVersion" /v InstalledLanguage /t REG_DWORD /d %CHOICE_LANG% /f >nul 2>&1
