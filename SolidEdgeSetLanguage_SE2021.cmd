...
rem SolidEdgeSetLanguage_SE2021.cmd
rem Copyright (C) 2020, David C. Merritt, david.c.merritt@siemens.com
rem
...
rem ---------------------------------------------------------------------
rem
rem 22/09/2020  merritt  initial release
rem

set SE_HOME=C:\Program Files\Siemens\Solid Edge 2021
...
rem
:ChangeLang
reg delete "HKCU\Software\Siemens\Solid Edge\Version 221" /v DefaultToSystemLocale /f >nul 2>&1

reg delete "HKCU\Software\Siemens\Solid Edge\Version 221" /v RuntimeLanguage /f >nul 2>&1

reg add "HKLM\Software\Siemens\Solid Edge\Version 221\CurrentVersion" /v InstalledLanguage /t REG_DWORD /d %CHOICE_LANG% /f >nul 2>&1
