...
rem SolidEdgeSetLanguage_SE2023.cmd
...
set SE_HOME=C:\Program Files\Siemens\Solid Edge 2023
...
:MenuTemplate
cls
echo        ษอออออออออออออออออออออออ๏ฟฝ๏ฝ๏ฟฝ๏ฟฝ
echo        บ   Solid Edge Language    บ
echo        ฬอออออออออออออออออออออออออ๏ฟฝ๏ฟ
echo        บ                          บ
...
echo        บ (X) Exit                 บ
echo        บ                          บ
echo        ศออออออออออออออออออออออออ๏ฟ๏๏ฟฝ  
echo.
echo.
...
rem
:ChangeLang
reg delete "HKCU\Software\Siemens\Solid Edge\Version 223" /v DefaultToSystemLocale /f >nul 2>&1

reg delete "HKCU\Software\Siemens\Solid Edge\Version 223" /v RuntimeLanguage /f >nul 2>&1

reg add "HKLM\Software\Siemens\Solid Edge\Version 223\CurrentVersion" /v InstalledLanguage /t REG_DWORD /d %CHOICE_LANG% /f >nul 2>&1
