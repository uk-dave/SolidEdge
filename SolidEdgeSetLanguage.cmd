...
rem SolidEdgeSetLanguage.cmd
rem Copyright (C) 2018, David C. Merritt, david.c.merritt@siemens.com
rem
...
rem ---------------------------------------------------------------------
rem
rem 01/02/2018  merritt  initial release
rem

set SE_HOME=C:\Program Files\Solid Edge ST10
...
rem
:ChangeLang
reg delete "HKCU\Software\Unigraphics Solutions\Solid Edge\Version 110" /v DefaultToSystemLocale /f >nul 2>&1

reg delete "HKCU\Software\Unigraphics Solutions\Solid Edge\Version 110" /v RuntimeLanguage /f >nul 2>&1

reg add "HKLM\SOFTWARE\Unigraphics Solutions\Solid Edge\Version 110\CurrentVersion" /v InstalledLanguage /t REG_DWORD /d %CHOICE_LANG% /f >nul 2>&1
