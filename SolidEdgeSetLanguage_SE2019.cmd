...
rem SolidEdgeSetLanguage_SE2019.cmd
...
rem ---------------------------------------------------------------------
rem
rem 31/07/2018  merritt  initial release
rem

set SE_HOME=C:\Program Files\Siemens\Solid Edge 2019
...
rem
:ChangeLang
reg delete "HKCU\Software\Siemens\Solid Edge\Version 219" /v DefaultToSystemLocale /f >nul 2>&1

reg delete "HKCU\Software\Siemens\Solid Edge\Version 219" /v RuntimeLanguage /f >nul 2>&1

reg add "HKLM\Software\Siemens\Solid Edge\Version 219\CurrentVersion" /v InstalledLanguage /t REG_DWORD /d %CHOICE_LANG% /f >nul 2>&1
